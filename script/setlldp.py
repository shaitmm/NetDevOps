...
{"hostname": "vIOS16", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.116"},
{"hostname": "vIOS17", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.117"},
{"hostname": "vIOS18", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.118"},
{"hostname": "vIOS19", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.119"},
{"hostname": "vIOS20", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.120"},
{"hostname": "vIOS21", "port": 22, "username": "admin", "password":"admin","device_type":"cisco_ios","ip":"172.20.3.121"},
]
...
#    data_path = "../data/"
 ...
 #   data = yaml.load(open(data_file[0]).read())
    if hostname.startswith("xrv"):
        return template.render(commit=True)
    elif hostname.startswith("vIOS"):
        return template.render()

def set_config(device):

    cfgs = get_config(device.get("hostname"), "lldp")
    print(cfgs)
    del device["hostname"]
